...
{
    /// <inheritdoc />
    public partial class FinalFixMySqlPrecision : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SemesterId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    SemesterName = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WalletBalance = table.Column<decimal>(type: "decimal(15,2)", precision: 15, scale: 2, nullable: false, defaultValue: 0m),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    SubjectId = table.Column<int>(type: "int", nullable: false),
                    PreSubjectId = table.Column<int>(type: "int", nullable: false),
                    Status = table.Column<int>(type: "int", nullable: true, defaultValue: 1)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Prerequisites", x => new { x.SubjectId, x.PreSubjectId });
                    table.ForeignKey(
                        name: "FK_Prerequisites_PreSubjects",
                        column: x => x.PreSubjectId,
                        principalTable: "Subjects",
                        principalColumn: "SubjectId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Prerequisites_Subjects",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SecondDay = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Transactions_Semesters_SemesterId",
                        column: x => x.SemesterId,
                        principalTable: "Semesters",
                        principalColumn: "SemesterId");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MidtermScore = table.Column<decimal>(type: "decimal(65,30)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AnalysisId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    GradeId = table.Column<int>(type: "int", nullable: false),
                    AI_Feedback = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Status = table.Column<int>(type: "int", nullable: true, defaultValue: 1),
                    AnalysisDate = table.Column<DateTime>(type: "datetime(6)", nullable: false, defaultValueSql: "CURRENT_TIMESTAMP(6)")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AcademicAnalyses", x => x.AnalysisId);
                    table.ForeignKey(
                        name: "FK_AcademicAnalyses_Grades_GradeId",
                        column: x => x.GradeId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AcademicAnalyses_GradeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Prerequisites_PreSubjectId",
                table: "Prerequisites",
                column: "PreSubjectId");

            migrationBuilder.CreateIndex(
                name: "IX_Transactions_SemesterId",
                table: "Transactions",
                column: "SemesterId");
